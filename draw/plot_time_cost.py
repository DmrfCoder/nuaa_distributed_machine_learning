...
data = np.loadtxt('/Users/dmrfcoder/Documents/毕业设计/code/nuaa_distributed_machine_learning/bsp_to_worker.txt')
...
#plt.plot(bsp_to_worker_time_start, color='red', label='bsp_to_worker_time_start')
